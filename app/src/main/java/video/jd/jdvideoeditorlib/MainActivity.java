...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    final String testVideo = path + "back_1.mp4";
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.sample_text) {
            ...
            // 转场黑屏(设置COLOR视频变黑)
            String blackEnd = "-i %s -filter_complex fade=t=in:st=0:d=3,fade=t=out:st=6:d=3 -c:v mpeg4 -q:v 1 -y %s";
            res = String.format(blackEnd, testVideo, path + "out.mp4");
//            // 动图淡入淡出
