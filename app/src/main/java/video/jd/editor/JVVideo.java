...
public class JVVideo {
	...
	//特效
	private ArrayList<JVDraw> epPics;

	//裁剪
	private Crop mCrop;


	public JVVideo(String videoPath) {
	 ...
	 * @return
	 */
	public JVVideo clip(float start, float duration) {
		isClip = true;
	 ...
	 * @return
	 */
	public JVVideo rotation(int rotation, boolean isFlip) {
		filter = getFilter();
		if (isFlip) {
			switch (rotation) {
				case 0:
	 ...
	 * @return
	 */
	public JVVideo crop(float width, float height, float x, float y) {
		filter = getFilter();
	 ...
	 */
	@Deprecated
	public JVVideo addText(int x, int y, float size, String color, String ttf, String text) {
		filter = getFilter();
	 ...
	 * @param epText  添加文字类
	 */
	public JVVideo addText(JVText epText) {
		filter = getFilter();
	 ...
	 */
	public JVVideo addTime(int x, int y, float size, String color, String ttf, int type){
	 ...
	 * @return
	 */
	public JVVideo addFilter(String ofi) {
		filter = getFilter();
		filter.append(ofi);
		return this;
	}
	 ...
	 * @return
	 */
	public JVVideo addDraw(JVDraw epDraw) {
		epPics.add(epDraw);
		return this;
	}
	 ...
	 * @return
	 */
	public ArrayList<JVDraw> getEpDraws() {
		return epPics;
	}
